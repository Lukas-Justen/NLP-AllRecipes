class RecipeBuilder(object):
    ...
    def create_recipe(self):
        return Recipe(self.ingredients, self.prep_time, self.cook_time, self.total_time, self.servings_count,self.recipe_name)


class Recipe(object):

    def __init__(self, ingredients, prep_time, cook_time, total_time, servings_count, recipe_name):
